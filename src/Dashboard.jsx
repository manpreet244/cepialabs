    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="px-8 pt-4">
        ...
        <div className="grid grid-cols-5 gap-6 mb-6 items-stretch">
          ...
          <div className="relative rounded-2xl col-span-2 p-0 shadow-lg flex flex-col justify-between h-full min-h-[220px] overflow-hidden">
            <img src="/bgimage.jpg" alt="Rocket" className="absolute inset-0 w-full h-full object-cover opacity-60" />
            <div className="absolute inset-0 bg-gradient-to-br from-blue-900 to-blue-700 opacity-80"></div>
            <div className="relative z-10 p-6 flex flex-col h-full justify-between">
              <h2 className="text-white text-xl font-bold mb-2">Work with the rockets</h2>
              ...
              <div className="text-white font-semibold flex items-center gap-2 cursor-pointer hover:text-blue-300">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-white rounded-2xl shadow-lg flex items-center justify-center min-h-[220px]">
            <img src="/bargraph.jpg" className="w-full h-full object-cover rounded-xl" />
          </div>
          <div className="bg-white rounded-2xl p-6 shadow-lg min-h-[220px]">
            <h2 className="text-lg font-semibold text-gray-700 mb-2">Sales Overview</h2>
            <div className="text-green-500 text-sm font-semibold mb-2">↑ 4% more in 2021</div>
            <img src="/sales.png" alt="Sales" className="w-full h-full object-cover"/>
          </div>
        </div>
      </div>
    </div>
